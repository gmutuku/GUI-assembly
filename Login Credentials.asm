...
.DATA
    ...
    menu_msg db "1. Register  2. Login  3. Exit", 10, 13, "$"
    invalid_choice_msg db "Invalid choice. Please select 1, 2, or 3.", 10, 13, "$"
...
register:
    ; User registration
    ; You can add code here to register a new user
